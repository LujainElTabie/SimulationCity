...
public class Simulator implements WorldListener {
	...
	public void nextCycle() {
		...
		if(checkGameOver()) {
			window.getGameo2().setText("NUMBER OF PEOPLE YOU KILLED: " + calculateCasualties());
			window.getGameOver().setVisible(true);
		}
		...
		window.updatec(calculateCasualties());
		
		
		window.updatecycle(currentCycle);
		...
		window.updateDInfo(this.DisasterInfo(), this.DeadCitizens());
